...
plot "VISUAL/point63_4.dat" u ($1+0):($2+0):3 with labels point pt 7 ps 2 offset char 1,1 notitle, \
"VISUAL/vector63_4.dat" using ($1+0):($2+0):($3+0):($4+0) with vectors filled head lw 2 notitle; \
unset object
